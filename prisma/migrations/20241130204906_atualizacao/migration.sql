...
CREATE TABLE `Income` (
    `id` VARCHAR(191) NOT NULL,
    `fonte` ENUM('SALARIO', 'FREELANCE', 'INVESTIMENTO', 'ALUGUEL', 'VENDA', 'OUTROS') NOT NULL,
    `tipo` ENUM('FIXA', 'VARIADA') NOT NULL,
    `categoria` ENUM('RENDA_PRINCIPAL', 'RENDA_SECUNDARIA', 'BONUS', 'COMISSAO', 'ALUGUEL', 'JUROS', 'VENDA', 'OUTROS') NOT NULL,
    `forma_pagamento` ENUM('DINHEIRO', 'CARTAO_DE_CREDITO', 'CARTAO_DE_DEBITO', 'TRANSFERENCIA', 'PIX', 'BOLETO', 'CRIPTOMOEDA') NOT NULL,
